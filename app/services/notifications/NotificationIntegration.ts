...
import { NotificationType, NotificationCategory, NotificationPriority } from './types';
    ...
    static async setupTimerNotifications(timerId: string, duration: number): Promise<void> {
        try {
            ...
            await notificationService.scheduleNotification({
                ...
                actions: ['view_timer', 'start_session'],
            });
    ...
    static async sendAchievementNotification(
        ...
        try {
            ...
            await notificationService.sendImmediateNotification({
                ...
                actions: ['view_milestones', 'complete_task'],
