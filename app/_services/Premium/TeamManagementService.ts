...
export class TeamManagementService {
    ...
    async createTeamGoal(goal: Omit<TeamGoal, 'id' | 'currentValue'>): Promise<TeamGoal> {
        ...
        return {
            ...
            currentValue: 0,
            ...goal,
            startDate: (goal.startDate as any) instanceof Date ? (goal.startDate as any).toISOString() : goal.startDate,
            endDate: (goal.endDate as any) instanceof Date ? (goal.endDate as any).toISOString() : goal.endDate
        };
    }
}
